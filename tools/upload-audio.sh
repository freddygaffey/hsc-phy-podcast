...
#
# Usage:
#   ./tools/upload-audio.sh                       # remote=hsc-r2 bucket=hsc-phy-podcast
#   RCLONE_REMOTE=hsc-r2 R2_BUCKET=hsc-phy-podcast ./tools/upload-audio.sh
set -euo pipefail
...
R2_BUCKET="${R2_BUCKET:-hsc-phy-podcast}"
